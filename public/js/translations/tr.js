...
window.translations.tr = {
    ...
    editKey: "Key Düzenle",
    deleteKey: "Key Sil",
    enableKey: "Etkinleştir",
    disableKey: "Devre Dışı Bırak",
    keyName: "Ad",
    keyNamePlaceholder: "örn. my-laptop",
    apiKey: "API Key",
    revealKey: "Düz metni göster",
    copyKey: "Key kopyala",
    copyFailed: "Kopyalama başarısız",
    copiedKey: "Kopyalandı",
    keyPlaintextTitle: "Key oluşturuldu",
    keyPlaintextHint: "Şimdi kopyalayın — bir daha gösterilmeyecek.",
    keyUsage: "Kullanım",
    keyActive: "Etkin",
    keyDisabled: "Devre dışı",
    keyExpired: "Süresi doldu",
    validity: "Geçerlilik",
    durationDays: "Geçerlilik (gün)",
    durationDaysPlaceholder: "örn. 30",
    durationDaysHint: "0 veya boş = süresiz; sayaç ilk kullanımda başlar",
    ...
    noLimit: "Sınırsız",
    metricTokens: "token",
    metricRequests: "istek",
    limitValuePlaceholder: "Limit değeri",
    lastUsed: "Son Kullanım",
    totalKeys: "{count} key",
    keyUpdated: "Key güncellendi",
    keyDeleted: "Key silindi",
    resetUsage: "Kullanımı Sıfırla",
    usageReset: "Kullanım sıfırlandı",
    noApiKeys: "Henüz API key yok. Oluşturmak için tıklayın.",
    loadFailed: "Yükleme başarısız",
    saveFailed: "Kaydetme başarısız",
    revealFailed: "Düz metin alınamadı",
    saving: "Kaydediliyor...",
    done: "Tamam",
    confirmDeleteKeyPrompt: "Key silmek istediğinizden emin misiniz",
    confirmDeleteKey: "Silmeyi Onayla",
    noMatchingKeys: "Eşleşen key yok",
    ...
    updatedAgo: "{time} önce güncellendi",
    requests: "İstekler",
