...
window.translations.pt = {
    ...
    createKey: "Criar Key",
    editKey: "Editar Key",
    deleteKey: "Excluir Key",
    enableKey: "Ativar",
    disableKey: "Desativar",
    keyName: "Nome",
    keyNamePlaceholder: "ex.: my-laptop",
    apiKey: "API Key",
    revealKey: "Mostrar texto puro",
    copyKey: "Copiar Key",
    copyFailed: "Falha ao copiar",
    copiedKey: "Copiado",
    keyPlaintextTitle: "Key criada",
    keyPlaintextHint: "Copie agora — não será exibida novamente.",
    keyUsage: "Uso",
    keyActive: "Ativa",
    keyDisabled: "Desativada",
    keyExpired: "Expirada",
    validity: "Validade",
    durationDays: "Validade (dias)",
    durationDaysPlaceholder: "ex.: 30",
    durationDaysHint: "0 ou vazio = sem expiração; a contagem inicia no primeiro uso",
    neverExpires: "Sem expiração",
    daysValid: "{count} dias",
    expired: "Expirada",
    expiresIn: "Expira em {time}",
    spendingLimit: "Limite de Consumo",
    noLimit: "Ilimitado",
    metricTokens: "tokens",
    metricRequests: "requisições",
    limitValuePlaceholder: "Valor do limite",
    lastUsed: "Último Uso",
    totalKeys: "{count} keys",
    keyUpdated: "Key atualizada",
    keyDeleted: "Key excluída",
    resetUsage: "Redefinir Uso",
    usageReset: "Uso redefinido",
    noApiKeys: "Nenhuma API key ainda. Crie uma para começar.",
    loadFailed: "Falha ao carregar",
    saveFailed: "Falha ao salvar",
    revealFailed: "Falha ao obter texto puro",
    saving: "Salvando...",
    done: "Concluído",
    confirmDeleteKeyPrompt: "Tem certeza de que deseja excluir a key",
    confirmDeleteKey: "Confirmar Exclusão",
    noMatchingKeys: "Nenhuma key correspondente",
