...
window.translations.id = {
    ...
    deleteKey: "Hapus Key",
    enableKey: "Aktifkan",
    disableKey: "Nonaktifkan",
    keyName: "Nama",
    keyNamePlaceholder: "mis. my-laptop",
    apiKey: "API Key",
    revealKey: "Tampilkan teks asli",
    copyKey: "Salin Key",
    copyFailed: "Gagal menyalin",
    copiedKey: "Tersalin",
    keyPlaintextTitle: "Key dibuat",
    keyPlaintextHint: "Salin sekarang — tidak akan ditampilkan lagi.",
    keyUsage: "Penggunaan",
    keyActive: "Aktif",
    keyDisabled: "Nonaktif",
    keyExpired: "Kedaluwarsa",
    validity: "Masa Berlaku",
    durationDays: "Masa berlaku (hari)",
    durationDaysPlaceholder: "mis. 30",
    durationDaysHint: "0 atau kosong = tanpa batas waktu; hitungan dimulai pada penggunaan pertama",
    neverExpires: "Tanpa batas waktu",
    daysValid: "{count} hari",
    expired: "Kedaluwarsa",
    expiresIn: "Kedaluwarsa dalam {time}",
    spendingLimit: "Batas Penggunaan",
    noLimit: "Tanpa batas",
    metricTokens: "token",
    metricRequests: "permintaan",
    limitValuePlaceholder: "Nilai batas",
    lastUsed: "Terakhir Dipakai",
    totalKeys: "{count} key",
    keyUpdated: "Key diperbarui",
    keyDeleted: "Key dihapus",
    resetUsage: "Reset Penggunaan",
    usageReset: "Penggunaan direset",
    noApiKeys: "Belum ada API key. Buat satu untuk memulai.",
    loadFailed: "Gagal memuat",
    revealFailed: "Gagal mengambil teks asli",
    saving: "Menyimpan...",
    done: "Selesai",
    confirmDeleteKeyPrompt: "Yakin ingin menghapus key",
    confirmDeleteKey: "Konfirmasi Hapus",
    noMatchingKeys: "Tidak ada key yang cocok",
