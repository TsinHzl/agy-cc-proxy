...
window.translations.zh = {
    ...
    exportLogs: "导出日志",
    emptyStreamHint: "尚未收到日志，等待服务端推送…",
    emptyNoMatch: "没有匹配当前筛选的日志",
    ...
    disableKey: "停用",
    keyName: "名称",
    keyNamePlaceholder: "例如：my-laptop",
    revealKey: "查看明文",
    copyKey: "复制 Key",
    copiedKey: "已复制",
    keyPlaintextTitle: "Key 已创建",
    keyPlaintextHint: "请立即复制保存——明文仅此一次展示，之后不再显示。",
    keyUsage: "用量",
    keyActive: "启用",
    keyDisabled: "已停用",
    keyExpired: "已过期",
    validity: "有效期",
    durationDays: "有效期（天）",
    durationDaysPlaceholder: "例如：30",
    durationDaysHint: "0 或留空 = 永不过期；计时从首次调用开始（懒激活）",
    neverExpires: "永不过期",
    daysValid: "{count} 天",
    expired: "已过期",
    expiresIn: "{time}后过期",
    ...
    metricTokens: "tokens",
    metricRequests: "请求数",
    limitValuePlaceholder: "额度数值",
    lastUsed: "最近使用",
    totalKeys: "{count} 个 Key",
    keyUpdated: "Key 已更新",
    keyDeleted: "Key 已删除",
    resetUsage: "重置用量",
    usageReset: "用量已重置",
    noApiKeys: "暂无 API Key，点击右上角新建。",
    loadFailed: "加载失败",
    saveFailed: "保存失败",
    revealFailed: "获取明文失败",
    saving: "保存中...",
    done: "完成",
    confirmDeleteKeyPrompt: "确定要删除 Key",
    confirmDeleteKey: "确认删除",
    noMatchingKeys: "没有匹配的 Key",
