...
window.translations.en = {
    ...
    emptyStreamHint: "No logs yet — waiting for the server stream…",
    emptyNoMatch: "No logs match the current filter",
    ...
    disableKey: "Disable",
    keyName: "Name",
    keyNamePlaceholder: "e.g. my-laptop",
    revealKey: "Reveal key",
    copyKey: "Copy key",
    copiedKey: "Key copied",
    keyPlaintextTitle: "API Key Created",
    keyPlaintextHint: "Copy it now — it will not be shown again.",
    keyUsage: "Usage",
    keyActive: "Active",
    ...
    durationDaysHint: "0 or empty = never expires; the timer starts on first use",
    neverExpires: "Never expires",
    daysValid: "{count} days",
    expired: "Expired",
    ...
    limitValuePlaceholder: "Limit value",
    lastUsed: "Last Used",
    ...
    confirmDeleteKeyPrompt: "Are you sure you want to delete key",
